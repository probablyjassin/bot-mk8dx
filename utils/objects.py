...
async def get_lounge_role(name: str) -> Role:
    return get((await get_guild()).roles, name=name)

async def get_inmogi_role() -> Role:
    return get((await get_guild()).roles, name="InMogi")

async def get_mogi_manager_role() -> Role:
    return get((await get_guild()).roles, name="Mogi Manager")

async def get_moderator_role() -> Role:
    return get((await get_guild()).roles, name="Moderator")

async def get_admin_role() -> Role:
    return get((await get_guild()).roles, name="Admin")